...
public abstract class GeneratedVaadinTabFactory<R extends GeneratedVaadinTab<R>> extends FluentFactory<GeneratedVaadinTab<R>, GeneratedVaadinTabFactory<R>>
    implements IGeneratedVaadinTabFactory<GeneratedVaadinTab<R>, GeneratedVaadinTabFactory<R>, R> {

  public GeneratedVaadinTabFactory(final GeneratedVaadinTab<R> generatedVaadinTab) {

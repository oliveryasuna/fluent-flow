...
public interface ITextFieldFactory<T extends TextField, F extends ITextFieldFactory<T, F>> extends IFluentFactory<T, F>,
    IGeneratedVaadinTextFieldFactory<T, F, TextField, String>, HasSizeFactory<T, F>, HasValidationFactory<T, F>, HasPrefixAndSuffixFactory<T, F>,
    InputNotifierFactory<T, F>, KeyNotifierFactory<T, F>, CompositionNotifierFactory<T, F>, HasAutocompleteFactory<T, F>, HasAutocapitalizeFactory<T, F>,
    HasAutocorrectFactory<T, F>, HasHelperFactory<T, F> {

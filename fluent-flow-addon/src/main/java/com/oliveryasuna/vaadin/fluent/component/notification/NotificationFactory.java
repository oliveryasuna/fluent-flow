...
public class NotificationFactory extends ComponentFactory<Notification, NotificationFactory> implements INotificationFactory<Notification, NotificationFactory> {
